...
def map_2_words_to_word(corpus):
    """Load lists and use dictionary to map word-pair to trailing word."""
    limit = len(corpus) - 2
...
def haiku_line(suffix_map_1, suffix_map_2, corpus, end_prev_line, target_syls):
    """Build a new haiku line from a training corpus and return it."""
    line = "2/3"
    line_syls = 0
    current_line = []
...
def main():
    ...
    while choice != "0":
        ...
        #some unknown choice
            ...
            print("Sorry, but that isn't a valid choice.")
            continue
